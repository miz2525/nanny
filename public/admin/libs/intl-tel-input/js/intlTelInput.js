...
(function(factory) {
    ...
    return function() {
        ...
        var queryString = full_url.split('/');
        if (queryString[3] == 'car-application-form' && queryString[4] == 'third-party' && (queryString[5] == 'salama' || queryString[5] == 'wathba' || queryString[5] == 'oman')) {
            var allCountries = [
                ["United Arab Emirates (‫الإمارات العربية المتحدة‬‎)", "ae", "05"]
            ];
        } else {
            var allCountries = [
