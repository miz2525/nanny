      ...
      <div class="col-xl-6 col-lg-7 col-md-8 col-xs-11 order-2 order-lg-1" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
        <div class="welcome-content welcome-content--l1">
          ...
          <p class="welcome-content__terms-text">
              ...
              <a href="{{ route('ethical-considerations-for-hiring-a-nanny') }}">Ethical considerations for hiring a nanny</a> and
              <a class="btn btn-link" href="{{ route('eligibility-criteria-for-hiring-a-nanny') }}">Eligibility criteria for hiring a nanny</a>
          </p>
        </div>
      </div>
      <!--/ .Welcome Content Area -->
